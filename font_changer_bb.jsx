...
if (sourceFolder)
{
    ...
    var exportFolder = Folder(sourceFolder + "/font_replaced_ai");
    var finalFolder = Folder(sourceFolder + "/font_replaced_eps");
...
for (var a = 0; a < found_font_array_2.length; a++)
{
    ...
    one_group.add('statictext', undefined, '   発見した　' + found_family_array_2[a] + ' ' + found_style_array_2[a] + '   を  ');
    ddown_array_family[a] = one_group.add('dropdownlist', undefined, empty);
    ddown_array_style[a] = one_group.add('dropdownlist', undefined, empty);
    ddown_array_style[a].size = [100, 20];
    one_group.add('statictext', undefined, '  に変えます');
